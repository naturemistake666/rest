async function editUser(modal, id) {
        ...
        let bodyForm = `
            <form class="form-group text-center" id="editUser">
               ...
               <div class="form-group">
                    ...
                    <input type="text" class="form-control " id="username" value="${user.firstName}">
               </div>  
                
                <div class="form-group">
                    <label for="name" class="com-form-label">Last name</label>
                    <input type="text" class="form-control" id="name" value="${user.lastName}">
                </div>
    ...
    $("#editButton").on('click', async () => {
        ...
        let firstName = modal.find("#username").val().trim();
        let lastName = modal.find("#name").val().trim();
